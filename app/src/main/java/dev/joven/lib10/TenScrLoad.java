...
public class TenScrLoad extends AppCompatActivity {
    mgdUtil tools;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ten_scr_load);
        tools = TenGlobalCFG.getTools(this);
        ...
        splashUI.createSplashUI(this, TenContent.class, R.raw.loading);
    }
}