...
public class TenContent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        policy.createPolicyDialog("https://www.iubenda.com/privacy-policy/18087873", "I Agree", Color.RED, "Dont Agree", Color.GREEN);
    }
    ...
    private void LaunchGameContent() {
        new Handler(Looper.getMainLooper()).postDelayed(() -> {
            ...
            gameView.createGameUI(mgdUtil.gameURL, true, "ca-app-pub-9426884596605370/3137068727");
        }, 300);
